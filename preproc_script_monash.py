...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  6 20:27:14 2021
...
###FOR EXTRACTION BELOW
# filenames = os.listdir()
# filenames = [filename for filename in filenames if ".zip" in filename]
...
def convert_tsf_to_dataframe(full_file_path_and_name, replace_missing_vals_with = 'NaN', value_column_name = "series_value"):
    ...
    # print("filename: ", full_file_path_and_name)
...
# # Example of usage
# loaded_data, frequency, forecast_horizon, contain_missing_values, contain_equal_length = convert_tsf_to_dataframe("nn5_daily_dataset_without_missing_values.tsf")
